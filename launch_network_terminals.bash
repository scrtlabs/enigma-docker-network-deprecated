...
WORKER_INDEX=1 docker-compose up &
...
xterm -geometry 150x20+20+330 -e 'docker-compose exec contract bash -c "cd enigma-contract && node integration/coin-mixer.js; bash"' &
